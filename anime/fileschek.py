...
def upload_cover(instance, filename, fieldname):
    ...
    path = f"/home/kutu/PycharmProjects/api_anime/media/{name_of_the_anime}/{file}"
...
def upload_episode(instance, filename, fieldname):
    ...
    hash256 = hashlib.sha256()
    file = getattr(instance, fieldname)
    path = f"/home/kutu/PycharmProjects/api_anime/media/{name_of_the_anime}/{season_number}/{file}"
